        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h2 class="text-xl font-bold dark:text-white mb-4">Edit content</h2>
                    ...
                    <form method="post" action="/contents/update" class="mt-4 pt-4" enctype="multipart/form-data">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6 gap-6 ">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <input type="text" name="content_value" id="" class="{{Config::get('site.formInputClass')}}" placeholder=" " value="{{$content->content_value}}" required />
                            </div>
                        </div>
